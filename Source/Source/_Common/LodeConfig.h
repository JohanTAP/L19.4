...
#define	NEUZ_TITLE	"Flyff V19"							//: Window title of the client.
#define	NEUZ_BHASH	"sunkist"							//: String to boot the client.
#define	NEUZ_IPSET	"192.168.191.1"						//: Ip of the server, must match AccountServer.ini & LoginServer.ini.
#define	NEUZ_CPORT	"49151"								//: Cache port, must match CacheServer.ini.
